...
if(!Array.isArray(matrix.rows)||!matrix.rows.length){ console.error('LOCAL SCOPE FAILED: the service/city/occasion matrix carries zero rows. An empty allowlist check enforces nothing.'); process.exit(1); }
